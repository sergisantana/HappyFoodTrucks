...
import com.happyfood.truck.recycler.CommentsAdapter;
import com.happyfood.truck.recycler.ItemComment;
import com.happyfood.truck.recycler.ItemPreparation;
import com.happyfood.truck.recycler.ItemShopping;
import com.happyfood.truck.recycler.PreparationAdapter;
import com.happyfood.truck.recycler.ShoppingAdapter;
...
public class Detail extends BaseActivity implements PreparationAdapter.ViewHolder.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar(R.id.toolbar, "Happy Food Trucks", android.R.color.white, android.R.color.transparent, R.drawable.ic_arrow_back);
        ...
        Glide.with(this).load(Uri.parse("http://www.gastronosfera.com/sites/default/files/uploads/x_malgrat-foto2ok.jpg.pagespeed.ic.2ojhaVzlXW.jpg")).into(image);

...
import com.happyfood.truck.utils.CustomTypefaceSpan;
...
public class Main extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar(R.id.toolbar, "Happy Food Trucks", R.color.colorPink, R.color.colorWhiteTrans, R.drawable.ic_burger);
        ...
        Glide.with(this)
                .load(Uri.parse("https://pbs.twimg.com/profile_images/707912356827889664/ozoO2iXR.jpg"))
